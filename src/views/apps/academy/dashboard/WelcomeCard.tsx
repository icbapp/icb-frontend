...
const WelcomeCard = () => {
  ...
  const getChartColors = () => [
    ...
    '#D65DB1', '#FF9671', '#00C9A7', '#2C73D2', '#F9F871',
    '#F5B971', '#9A0680',
  ]
  ...
  const labels = [
    ...
    '7th Std', '8th Std', '9th Std', '10th Std', '11th Std', '12th Std',
  ]
      ...
      <div className="flex max-md:flex-col md:items-stretch gap-0">
        ...
        <div className="w-full md:12 p-2 sm:p-6">
          ...
          {/* <div className="mb-6 max-w-lg">
            <Typography color="text.secondary">Here is the summary of</Typography>
            <Typography className="font-bold ml-1" color="text.primary">
              {adminStore?.name ?? ''}
            </Typography>
            <Typography color="text.secondary">
              Track student activity and manage your tasks efficiently.
            </Typography>
          </div> */}
        ...
        {/* {belowMdScreen ? (
          ...
          <Divider orientation="vertical" className="mx-0" flexItem />
        )} */}

        {/* Right side */}
        {/* <div
          className={`md:w-4/12 w-full p-6 rounded-r-xl flex flex-col ${theme.palette.mode === 'dark'
        ...
        >
          <div className="flex flex-col justify-between h-full">
            <div>
              <Typography variant="h5" className="font-bold mb-1" color="text.primary">
                Fees Collection
              </Typography>
              <Typography color="text.secondary" className="text-sm mb-6">
                Monthly report (1st to 12th Standard)
              </Typography>

              <Typography variant="h4" className="font-bold mb-2" color="text.primary">
                92<span className="text-textSecondary">%</span> Collected
              </Typography>
            ...
            <div className="mt-4 rounded-lg p-4 shadow-sm">
              <Typography className="font-medium mb-3" color="text.secondary">
                Standard Distribution
              </Typography>
              <ul className="grid grid-cols-3 gap-x-4 gap-y-3">
                {trimmedColors.map((color, idx) => (
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                  <div
                    ...
                    style={{ width: '72%', backgroundColor: theme.palette.primary.main }}
                  />
                </div>
              </div>
            </div>
